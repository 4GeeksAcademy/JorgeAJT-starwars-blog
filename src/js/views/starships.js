...
export const Starships = () => {
	...
	<div className="text-center mt-3">
		<h1 className="text-white title mb-4" style={{ "backgroundImage" : `url(https://raw.githubusercontent.com/tbone849/star-wars-guide/master/build/assets/img/categories/starships-mobile.jpg)` }}>Starships</h1>
